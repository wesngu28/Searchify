...
export default function Blurb({blurb, type, adjectives}: Props) {
    ...
    if(type === 'artist') {
        ...
        return(
            <div className={blurbStyles.info}>
                <img alt="image of requested artist" className={blurbStyles.spotify} src={blurb.img}></img>
    ...
    if(type === 'song') {
        ...
        return(
            <div className={blurbStyles.info}>
                <img alt="cover image of requested track" className={blurbStyles.spotify} src={blurb.img}></img>
    ...
    if(type === 'playlist') {
        ...
        return(
            <div className={blurbStyles.info}>
                <img alt="cover image of requested playlist" className={blurbStyles.spotify} src={blurb.img}></img>
    ...
    if(type === 'album') {
        ...
        return(
            <div className={blurbStyles.info}>
                <img alt="cover image of requested album" className={blurbStyles.spotify} src={blurb.img}></img>
    ...
    if(type === 'user') {
        ...
        return (
            <div className={blurbStyles.info}>
                <img alt="avatar of requested user" className={blurbStyles.spotify} src={blurb.img}></img>
